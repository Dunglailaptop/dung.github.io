...
<!--    <body>
        ...
        <div>
            <h4>${userName}</h4> comment 
            <ul>
                <li><a href="change?pid=kh10">home</a> </li> comment 
                <li><a href="login">login</a> </li> comment 
                <li><a href="phantrang?index=1">Product List</a> </li>
                <li><a href="DANGNHAP.jsp">from</a> </li>
                <li><a href="./newjsp.jsp">Sign in</a> </li>
                <h3></h3>
            </ul>
        ...
        <div class="warpper">
            <div class="header_menu">
                ...
                <ul class="main-menu">
                    ...
                    <li class="ds"><a href="phantrang?index=1"><i class="far fa-list-alt icon"></i>Product List</a></li><!-- comment -->
