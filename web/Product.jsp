                      ...
                      <div class="select-input">
                          ...
                          <ul class="select-input_list">
                              <li class="select-input-item">
                                  <a href="sapxeptangdan" class="select-input_link">gia: thap den cao</a>
                              </li>   
                              <li class="select-input-item">
                                  <a href="sapxepgiamdan" class="select-input_link">gia: cao den thap</a>
                              </li>
                          </ul>
                  ...
                  <div class="home-product">
                      <div class="grid_row">
                             ...
                             <div class="grid_column-2-4">
                              <a class="home-product-item" href="detail?pid=${product.id}">
...
<!--                       <li class="pagination_item pagination_item_active">
                       ...
                       <li class="pagination_item">
                          <a href="phantrang?index=${i}" class="pagination_item_link">
                              ${i}
                          </a>
                       </li><!-- comment -->
                  </c:forEach>
