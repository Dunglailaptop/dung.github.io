 ...
 * @author USER
 */
@WebServlet(urlPatterns = {"/sapxepgiamdan"})
public class sapxepgiamdan extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet sapxepgiamdan</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet sapxepgiamdan at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       String errorString = null;
		...
		try {
			...
			list = buttonmysql.xapsepgiamdan(conn);
