 ...
 * @author USER
 */
@WebServlet(urlPatterns = {"/sapxeptangdan"})
public class sapxeptangdan extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet sapxeptangdan</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet sapxeptangdan at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			list = buttonmysql.xapseptangdan(conn);
